...
public:
    ...
    void setupUi(QDialog *QgsPgNewConnectionBase)
    {
        ...
        QgsPgNewConnectionBase->resize(880, 600);
        ...
        scrollArea = new QgsScrollArea(QgsPgNewConnectionBase);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setFrameShape(QFrame::NoFrame);
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 936, 630));
        ...
        sizePolicy2.setHeightForWidth(TextLabel3_5->sizePolicy().hasHeightForWidth());
        TextLabel3_5->setSizePolicy(sizePolicy2);
    ...
    {
        QgsPgNewConnectionBase->setWindowTitle(QCoreApplication::translate("QgsPgNewConnectionBase", "Create a New PostgreSQL Connection", nullptr));
