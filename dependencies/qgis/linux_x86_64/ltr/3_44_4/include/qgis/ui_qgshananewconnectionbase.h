...
public:
    ...
    void setupUi(QDialog *QgsHanaNewConnectionBase)
    {
        ...
        QgsHanaNewConnectionBase->resize(464, 838);
        ...
        scrollArea = new QgsScrollArea(QgsHanaNewConnectionBase);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setFrameShape(QFrame::Shape::NoFrame);
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 452, 770));
        ...
        layoutWidget->setGeometry(QRect(0, 0, 421, 244));
        ...
        grdConnectionSettings->setSizeConstraint(QLayout::SizeConstraint::SetNoConstraint);
        ...
        frmMode->setFrameShape(QFrame::Shape::NoFrame);
        frmMode->setFrameShadow(QFrame::Shadow::Raised);
        ...
        frmMultipleContainers->setFrameShape(QFrame::Shape::NoFrame);
        frmMultipleContainers->setFrameShadow(QFrame::Shadow::Raised);
        ...
        frmMultitenantSettings->setFrameShape(QFrame::Shape::NoFrame);
        frmMultitenantSettings->setFrameShadow(QFrame::Shadow::Plain);
        ...
        txtTenantDatabaseName->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        lblMode->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignTop);
        ...
        txtProxyPassword->setEchoMode(QLineEdit::EchoMode::Password);
        ...
        verticalSpacer = new QSpacerItem(20, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Minimum);

        verticalLayout->addItem(verticalSpacer);


        verticalLayout_8->addWidget(GroupBox1);
