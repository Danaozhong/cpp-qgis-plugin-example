...
public:
    ...
    void setupUi(QDialog *QgsDwgImportBase)
    {
        ...
        mDatabaseFileWidget->setProperty("filter", QVariant(QString::fromUtf8("*.dwg;;*.DWG;;*.dxf;;*.DXF")));
        ...
        mSourceDrawingFileWidget->setProperty("filter", QVariant(QString::fromUtf8("*.gpkg;;*.GPKG")));
    ...
    void retranslateUi(QDialog *QgsDwgImportBase)
    {
        ...
        mDatabaseFileWidget->setProperty("dialogTitle", QVariant(QCoreApplication::translate("QgsDwgImportBase", "Select DWG/DXF file", nullptr)));
        ...
        mSourceDrawingFileWidget->setProperty("dialogTitle", QVariant(QCoreApplication::translate("QgsDwgImportBase", "Select GeoPackage Database", nullptr)));
