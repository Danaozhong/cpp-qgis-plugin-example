...
public:
    ...
    QGroupBox *mFetchLimitGroupBox;
    QGridLayout *gridLayout_3;
    QLabel *label_fetchLimit;
    ...
    void setupUi(QWidget *QgsRelReferenceConfigDlgBase)
    {
        ...
        mFetchLimitGroupBox = new QGroupBox(QgsRelReferenceConfigDlgBase);
        mFetchLimitGroupBox->setObjectName(QString::fromUtf8("mFetchLimitGroupBox"));
        mFetchLimitGroupBox->setCheckable(true);
        gridLayout_3 = new QGridLayout(mFetchLimitGroupBox);
        gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));
        label_fetchLimit = new QLabel(mFetchLimitGroupBox);
        label_fetchLimit->setObjectName(QString::fromUtf8("label_fetchLimit"));

        gridLayout_3->addWidget(label_fetchLimit, 0, 0, 1, 1);

        mFetchLimit = new QgsSpinBox(mFetchLimitGroupBox);
        mFetchLimit->setObjectName(QString::fromUtf8("mFetchLimit"));

        gridLayout_3->addWidget(mFetchLimit, 0, 1, 1, 1);


        gridLayout_2->addWidget(mFetchLimitGroupBox, 8, 0, 1, 2);
...
#if QT_CONFIG(tooltip)
        mFetchLimitGroupBox->setToolTip(QCoreApplication::translate("QgsRelReferenceConfigDlgBase", "If no limit is set, all entries are loaded.", nullptr));
#endif // QT_CONFIG(tooltip)
        mFetchLimitGroupBox->setTitle(QCoreApplication::translate("QgsRelReferenceConfigDlgBase", "Limit number of entries", nullptr));
        label_fetchLimit->setText(QCoreApplication::translate("QgsRelReferenceConfigDlgBase", "Maximum number of entries", nullptr));
