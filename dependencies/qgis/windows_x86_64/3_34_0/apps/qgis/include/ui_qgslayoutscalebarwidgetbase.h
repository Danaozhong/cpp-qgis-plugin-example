...
public:
    ...
    void setupUi(QWidget *QgsLayoutScaleBarWidgetBase)
    {
        ...
        label_5->setStyleSheet(QString::fromUtf8("padding: 2px; font-weight: bold; sbackground-color: palette(mid);"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 566, 1018));
        ...
        mMapUnitsPerBarUnitSpinBox->setShowClearButton(false);
        ...
        mSegmentSizeSpinBox->setShowClearButton(false);
