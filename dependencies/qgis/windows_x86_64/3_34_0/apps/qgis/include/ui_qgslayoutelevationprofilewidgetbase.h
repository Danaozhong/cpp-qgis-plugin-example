...
public:
    ...
    void setupUi(QWidget *QgsLayoutElevationProfileWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -51, 548, 1439));
        ...
        QWidget::setTabOrder(scrollArea, mSpinTolerance);
        QWidget::setTabOrder(mSpinTolerance, mDDBtnTolerance);
        QWidget::setTabOrder(mDDBtnTolerance, mCheckControlledByAtlas);
        QWidget::setTabOrder(mCheckControlledByAtlas, mSpinMinElevation);
        QWidget::setTabOrder(mSpinMinElevation, mSpinMinDistance);
        QWidget::setTabOrder(mSpinMinDistance, mSpinMaxDistance);
        QWidget::setTabOrder(mSpinMaxDistance, mSpinMaxElevation);
        QWidget::setTabOrder(mSpinMaxElevation, mDDBtnMinDistance);
        QWidget::setTabOrder(mDDBtnMinDistance, mDDBtnMaxDistance);
        QWidget::setTabOrder(mDDBtnMaxDistance, mDDBtnMinElevation);
        QWidget::setTabOrder(mDDBtnMinElevation, mDistanceUnitCombo);
        ...
        QWidget::setTabOrder(mDDBtnBottomMargin, mDDBtnMaxElevation);
