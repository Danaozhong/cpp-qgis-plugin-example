...
public:
    ...
    void retranslateUi(QWidget *QgsAuthSettingsWidget)
    {
        ...
        label_6->setText(QCoreApplication::translate("QgsAuthSettingsWidget", "Configurations store encrypted credentials in the QGIS authentication database.", nullptr));
