...
public:
    ...
    void setupUi(QDialog *QgsProjectPropertiesBase)
    {
        ...
        gridLayout_25->addLayout(gridLayout_9, 12, 0, 1, 2);
        ...
        gridLayout_25->addLayout(horizontalLayout_2, 11, 0, 1, 2);
        ...
        gridLayout_25->addLayout(grpWMSPrecision, 10, 0, 1, 2);
        ...
        mSkipNameForGroupCheckBox = new QCheckBox(wms);
        mSkipNameForGroupCheckBox->setObjectName(QString::fromUtf8("mSkipNameForGroupCheckBox"));

        gridLayout_25->addWidget(mSkipNameForGroupCheckBox, 9, 0, 1, 1);
