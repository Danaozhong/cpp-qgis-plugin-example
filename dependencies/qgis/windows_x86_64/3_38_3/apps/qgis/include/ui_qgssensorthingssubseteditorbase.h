...
public:
    ...
    void setupUi(QWidget *QgsSensorThingsSubsetEditorBase)
    {
        ...
        mLabelLogical_2 = new QLabel(groupBox4);
        mLabelLogical_2->setObjectName(QString::fromUtf8("mLabelLogical_2"));

        _3->addWidget(mLabelLogical_2, 2, 3, 1, 3);
    ...
    void retranslateUi(QWidget *QgsSensorThingsSubsetEditorBase)
    {
        ...
        lstFields->setWhatsThis(QCoreApplication::translate("QgsSensorThingsSubsetEditorBase", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">List of fields in this vector file</p></body></html>", nullptr));
        ...
        mLabelLogical_2->setText(QCoreApplication::translate("QgsSensorThingsSubsetEditorBase", "Date", nullptr));
