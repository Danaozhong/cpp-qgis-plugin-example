...
public:
    ...
    void setupUi(QWidget *Map3DConfigWidget)
    {
        ...
        gridLayout_11->addWidget(mDebugDepthMapGroupBox, 4, 0, 1, 1);
        ...
        gridLayout_11->addWidget(mDebugShadowMapGroupBox, 3, 0, 1, 1);
        ...
        gridLayout_11->addItem(verticalSpacerAdvanced, 5, 0, 1, 1);

        mAmbientOcclusionSettingsWidget = new QgsAmbientOcclusionSettingsWidget(groupAdvanced);
        mAmbientOcclusionSettingsWidget->setObjectName(QString::fromUtf8("mAmbientOcclusionSettingsWidget"));

        gridLayout_11->addWidget(mAmbientOcclusionSettingsWidget, 2, 0, 1, 1);
    ...
    void retranslateUi(QWidget *Map3DConfigWidget)
    {
        ...
        ___qlistwidgetitem3->setText(QCoreApplication::translate("Map3DConfigWidget", "Shadow", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem3->setToolTip(QCoreApplication::translate("Map3DConfigWidget", "Shadow settings", nullptr));
#endif // QT_CONFIG(tooltip)
