...
public:
    ...
    void setupUi(QDialog *QgsWMSSourceSelectBase)
    {
        ...
        QgsWMSSourceSelectBase->resize(744, 611);
        QIcon icon;
        ...
        mLoadLayersIndividuallyCheckBox = new QCheckBox(QgsWMSSourceSelectBase);
        ...
        gridLayout_2->addWidget(mLoadLayersIndividuallyCheckBox, 3, 0, 1, 1);
