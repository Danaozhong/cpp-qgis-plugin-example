...
public:
    ...
    void setupUi(QWidget *QgsVectorRenderingOptionsWidgetBase)
    {
        ...
        _14->addWidget(mSimplifyAlgorithmLabel, 2, 0, 1, 1);
        ...
        _14->addWidget(mSimplifyMaximumScaleComboBox, 4, 1, 1, 2);
        ...
        _14->addWidget(mSimplifyMaxScaleLabel, 4, 0, 1, 1);
        ...
        _14->addWidget(mSimplifyDrawingAtProvider, 3, 0, 1, 3);

        label_59 = new QLabel(mSimplifyDrawingGroupBox);
        label_59->setObjectName(QString::fromUtf8("label_59"));

        _14->addWidget(label_59, 0, 0, 1, 3);
        ...
        _14->addWidget(mSimplifyAlgorithmComboBox, 2, 1, 1, 2);

        label_65 = new QLabel(mSimplifyDrawingGroupBox);
        label_65->setObjectName(QString::fromUtf8("label_65"));
        label_65->setMargin(2);

        _14->addWidget(label_65, 1, 0, 1, 1);
        ...
        _14->addWidget(mSimplifyDrawingPx, 1, 2, 1, 1);
    ...
    void retranslateUi(QWidget *QgsVectorRenderingOptionsWidgetBase)
    {
        ...
        mSimplifyMaxScaleLabel->setText(QCoreApplication::translate("QgsVectorRenderingOptionsWidgetBase", "Maximum scale at which the layer should be simplified (1:1 always simplifies)", nullptr));
        ...
        label_65->setText(QCoreApplication::translate("QgsVectorRenderingOptionsWidgetBase", "Simplification threshold (higher values result in more simplification)", nullptr));
        mSimplifyDrawingPx->setText(QCoreApplication::translate("QgsVectorRenderingOptionsWidgetBase", "pixels", nullptr));
