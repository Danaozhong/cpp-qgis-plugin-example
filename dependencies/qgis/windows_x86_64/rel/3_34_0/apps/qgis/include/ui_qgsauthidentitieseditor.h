...
public:
    ...
    void retranslateUi(QWidget *QgsAuthIdentitiesEditor)
    {
        ...
        btnAddIdentity->setToolTip(QCoreApplication::translate("QgsAuthIdentitiesEditor", "Import identity bundle to authentication database", nullptr));
#endif // QT_CONFIG(tooltip)
        btnAddIdentity->setText(QString());
#if QT_CONFIG(tooltip)
        btnRemoveIdentity->setToolTip(QCoreApplication::translate("QgsAuthIdentitiesEditor", "Remove identity bundle from authentication database", nullptr));
#endif // QT_CONFIG(tooltip)
