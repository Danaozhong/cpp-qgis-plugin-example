...
public:
    ...
    void retranslateUi(QWidget *QgsRasterTransparencyWidget)
    {
        ...
        gboxNoDataValue->setTitle(QCoreApplication::translate("QgsRasterTransparencyWidget", "No Data Value", nullptr));
        label->setText(QCoreApplication::translate("QgsRasterTransparencyWidget", "Display no data as", nullptr));
#if QT_CONFIG(tooltip)
        lblUserNoDataValueLabel->setToolTip(QCoreApplication::translate("QgsRasterTransparencyWidget", "Additional user defined no data value.", nullptr));
#endif // QT_CONFIG(tooltip)
        lblUserNoDataValueLabel->setText(QCoreApplication::translate("QgsRasterTransparencyWidget", "Additional no data value", nullptr));
#if QT_CONFIG(tooltip)
        mSrcNoDataValueCheckBox->setToolTip(QCoreApplication::translate("QgsRasterTransparencyWidget", "Use original source no data value.", nullptr));
#endif // QT_CONFIG(tooltip)
        mSrcNoDataValueCheckBox->setText(QCoreApplication::translate("QgsRasterTransparencyWidget", "No data value", nullptr));
#if QT_CONFIG(tooltip)
        lblSrcNoDataValue->setToolTip(QCoreApplication::translate("QgsRasterTransparencyWidget", "Original data source no data value, if exists.", nullptr));
#endif // QT_CONFIG(tooltip)
        lblSrcNoDataValue->setText(QCoreApplication::translate("QgsRasterTransparencyWidget", "<src no data value>", nullptr));
#if QT_CONFIG(tooltip)
        leNoDataValue->setToolTip(QCoreApplication::translate("QgsRasterTransparencyWidget", "Additional user defined no data value.", nullptr));
#endif // QT_CONFIG(tooltip)
