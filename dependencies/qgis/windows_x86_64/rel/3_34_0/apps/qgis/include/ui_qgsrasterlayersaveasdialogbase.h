...
public:
    ...
    void retranslateUi(QDialog *QgsRasterLayerSaveAsDialogBase)
    {
        ...
        mRawModeRadioButton->setToolTip(QCoreApplication::translate("QgsRasterLayerSaveAsDialogBase", "Write out raw raster layer data. Optionally user defined no data values may be applied.", nullptr));
...
#if QT_CONFIG(tooltip)
        mNoDataGroupBox->setToolTip(QCoreApplication::translate("QgsRasterLayerSaveAsDialogBase", "Additional no data values. The specified values will be set to no data in output raster.", nullptr));
#endif // QT_CONFIG(tooltip)
        mNoDataGroupBox->setTitle(QCoreApplication::translate("QgsRasterLayerSaveAsDialogBase", "No data values", nullptr));
#if QT_CONFIG(tooltip)
