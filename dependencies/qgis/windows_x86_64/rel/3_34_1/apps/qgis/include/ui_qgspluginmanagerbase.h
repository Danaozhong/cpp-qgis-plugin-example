...
public:
    ...
    void retranslateUi(QDialog *QgsPluginManagerBase)
    {
        ...
        lblCheckUpdates->setText(QCoreApplication::translate("QgsPluginManagerBase", "<html><head/><body><p><span style=\" font-weight:600;\">If this function is enabled, QGIS will inform you whenever a plugin update is available.</span> Otherwise, fetching repositories will be performed during opening of the Plugin Manager window.</p></body></html>", nullptr));
