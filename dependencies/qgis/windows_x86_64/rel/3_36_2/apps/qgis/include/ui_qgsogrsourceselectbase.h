...
public:
    ...
    void setupUi(QDialog *QgsOgrSourceSelectBase)
    {
        ...
        QgsOgrSourceSelectBase->resize(522, 786);
        QIcon icon;
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 506, 78));
    ...
    void retranslateUi(QDialog *QgsOgrSourceSelectBase)
    {
        ...
        mOpenOptionsGroupBox->setProperty("title", QVariant(QCoreApplication::translate("QgsOgrSourceSelectBase", "Options", nullptr)));
