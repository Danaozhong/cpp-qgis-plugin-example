...
public:
    ...
    void retranslateUi(QDialog *QgsPointCloudQueryBuilderBase)
    {
        ...
        lstAttributes->setWhatsThis(QCoreApplication::translate("QgsPointCloudQueryBuilderBase", "<html><head/><body><p>List of attributes in this point cloud</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        groupBox2->setTitle(QCoreApplication::translate("QgsPointCloudQueryBuilderBase", "Values", nullptr));
#if QT_CONFIG(whatsthis)
        lstValues->setWhatsThis(QCoreApplication::translate("QgsPointCloudQueryBuilderBase", "<html><head/><body><p>List of values for the current attribute.</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
