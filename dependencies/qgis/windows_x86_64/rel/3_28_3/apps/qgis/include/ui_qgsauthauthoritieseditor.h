...
public:
    ...
    void retranslateUi(QWidget *QgsAuthAuthoritiesEditor)
    {
        ...
        btnAddCa->setToolTip(QCoreApplication::translate("QgsAuthAuthoritiesEditor", "Import certificate(s) to authentication database", nullptr));
#endif // QT_CONFIG(tooltip)
        btnAddCa->setText(QString());
#if QT_CONFIG(tooltip)
        btnRemoveCa->setToolTip(QCoreApplication::translate("QgsAuthAuthoritiesEditor", "Remove certificate from authentication database", nullptr));
#endif // QT_CONFIG(tooltip)
