...
public:
    ...
    void setupUi(QWidget *WidgetBalloonCallout)
    {
        ...
        WidgetBalloonCallout->resize(371, 456);
        ...
        gridLayout_45->addWidget(mCalloutBlendModeDDBtn, 6, 3, 1, 1);
        ...
        gridLayout_45->addWidget(mCalloutBlendComboBox, 6, 1, 1, 2);
        ...
        gridLayout_45->addWidget(mCalloutBlendModeLbl, 6, 0, 1, 1);
        ...
        sizePolicy.setHeightForWidth(mCalloutFillStyleButton->sizePolicy().hasHeightForWidth());
        mCalloutFillStyleButton->setSizePolicy(sizePolicy);
        ...
        mWedgeWidthUnitWidget->setFocusPolicy(Qt::StrongFocus);
        ...
        sizePolicy1.setHeightForWidth(mWedgeWidthSpin->sizePolicy().hasHeightForWidth());
        mWedgeWidthSpin->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(mCornerRadiusSpin->sizePolicy().hasHeightForWidth());
        mCornerRadiusSpin->setSizePolicy(sizePolicy1);
        ...
        mCornerRadiusUnitWidget->setFocusPolicy(Qt::StrongFocus);
