...
public:
    ...
    {
        QgsPointCloudLayerSaveAsDialogBase->setWindowTitle(QCoreApplication::translate("QgsPointCloudLayerSaveAsDialogBase", "Save Vector Layer as\342\200\246", nullptr));
