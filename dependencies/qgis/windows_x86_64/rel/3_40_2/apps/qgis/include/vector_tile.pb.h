...
class Tile_Value final :
 ...
 public:
  ...
  inline Tile_Value(const Tile_Value& from)
      : Tile_Value(nullptr, from) {}
...
class Tile_Feature final :
 ...
 public:
  ...
  inline Tile_Feature(const Tile_Feature& from)
      : Tile_Feature(nullptr, from) {}
...
class Tile_Layer final :
 ...
 public:
  ...
  inline Tile_Layer(const Tile_Layer& from)
      : Tile_Layer(nullptr, from) {}
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Tile_Feature::_internal_tags()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.tags_;
}
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Tile_Feature::_internal_geometry()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
