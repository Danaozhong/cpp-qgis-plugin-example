...
public:
    ...
    void setupUi(QDialog *QgsProjectPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 673, 852));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 694, 789));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 694, 789));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 685, 791));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 685, 791));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 671, 1396));
