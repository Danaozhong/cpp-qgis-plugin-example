...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 653, 681));
...
"border-radius: 2px;"));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 653, 681));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 653, 681));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 653, 681));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 695, 667));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 639, 769));
    ...
    void retranslateUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        label_2->setText(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "displayed as", nullptr));
