...
public:
    ...
    void setupUi(QWidget *QgsAnnotationRectangleTextWidgetBase)
    {
        ...
        QgsAnnotationRectangleTextWidgetBase->resize(321, 716);
        ...
        gridLayout->addWidget(mVerticalAlignmentComboBox, 5, 1, 1, 1);
        ...
        mTextFormatWidgetContainer = new QWidget(QgsAnnotationRectangleTextWidgetBase);
        mTextFormatWidgetContainer->setObjectName(QString::fromUtf8("mTextFormatWidgetContainer"));

        gridLayout->addWidget(mTextFormatWidgetContainer, 6, 0, 1, 2);
        ...
        gridLayout->addWidget(mAlignmentComboBox, 4, 1, 1, 1);
