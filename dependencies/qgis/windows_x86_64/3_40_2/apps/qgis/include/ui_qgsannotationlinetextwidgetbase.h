...
public:
    ...
    void setupUi(QWidget *QgsAnnotationLineTextWidgetBase)
    {
        ...
        mInsertExpressionButton->setPopupMode(QToolButton::ToolButtonPopupMode::MenuButtonPopup);
        mInsertExpressionButton->setToolButtonStyle(Qt::ToolButtonStyle::ToolButtonTextOnly);
        mInsertExpressionButton->setArrowType(Qt::ArrowType::DownArrow);
        ...
        mOffsetUnitWidget->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
