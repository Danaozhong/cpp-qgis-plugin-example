...
public:
    ...
    void setupUi(QWidget *QgsLayoutScaleBarWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 566, 1031));
        ...
        groupBox->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
        ...
        mGroupBoxUnits->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
        ...
        mMethodCombo = new QComboBox(mGroupBoxUnits);
        mMethodCombo->setObjectName(QString::fromUtf8("mMethodCombo"));

        gridLayout_2->addWidget(mMethodCombo, 4, 1, 1, 1);
        ...
        mGroupBoxSegments->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
        ...
        groupBox_5->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
        ...
        QWidget::setTabOrder(mNumberFormatPushButton, mMethodCombo);
        QWidget::setTabOrder(mMethodCombo, mGroupBoxSegments);
