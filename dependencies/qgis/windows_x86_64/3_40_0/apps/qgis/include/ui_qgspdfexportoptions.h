...
public:
    ...
    void setupUi(QDialog *QgsPdfExportOptionsDialog)
    {
        ...
        gridLayout_3->addWidget(mGeospatialPdfFormatComboBox, 1, 1, 1, 1);
        ...
        gridLayout_3->addWidget(mExportGeospatialPdfFeaturesCheckBox, 3, 0, 1, 2);
        ...
        QWidget::setTabOrder(mGeospatialPdfFormatComboBox, mIncludeMapThemesCheck);
