...
public:
    ...
    void setupUi(QWidget *QgsLayoutElevationProfileWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 548, 1375));
        ...
        sizePolicy2.setHeightForWidth(mDistanceAxisLabelFontButton->sizePolicy().hasHeightForWidth());
        mDistanceAxisLabelFontButton->setSizePolicy(sizePolicy2);

        gridLayout_2->addWidget(mDistanceAxisLabelFontButton, 6, 2, 1, 2);
        ...
        gridLayout_2->addWidget(mDistanceAxisLabelFormatButton, 5, 2, 1, 2);
        ...
        gridLayout_2->addWidget(mDDBtnDistanceMinorInterval, 2, 3, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(mDistanceAxisMajorLinesSymbolButton->sizePolicy().hasHeightForWidth());
        mDistanceAxisMajorLinesSymbolButton->setSizePolicy(sizePolicy3);

        gridLayout_2->addWidget(mDistanceAxisMajorLinesSymbolButton, 1, 2, 1, 2);
        ...
        gridLayout_2->addWidget(mDistanceAxisMinorIntervalSpin, 2, 2, 1, 1);
        ...
        gridLayout_2->addWidget(mDDBtnDistanceLabelInterval, 4, 3, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(mDistanceAxisMinorLinesSymbolButton->sizePolicy().hasHeightForWidth());
        mDistanceAxisMinorLinesSymbolButton->setSizePolicy(sizePolicy3);

        gridLayout_2->addWidget(mDistanceAxisMinorLinesSymbolButton, 3, 2, 1, 2);
        ...
        mDistanceAxisLabelIntervalSpin->setMinimum(0.000001000000000);
        mDistanceAxisLabelIntervalSpin->setMaximum(999999999999.000000000000000);

        gridLayout_2->addWidget(mDistanceAxisLabelIntervalSpin, 4, 2, 1, 1);
        ...
        gridLayout_2->addWidget(mDistanceAxisMajorIntervalSpin, 0, 2, 1, 1);
        ...
        gridLayout_2->addWidget(mDDBtnDistanceMajorInterval, 0, 3, 1, 1);
        ...
        gridLayout_2->addWidget(label_8, 4, 0, 1, 2);
        ...
        mElevationAxisLabelIntervalSpin->setMinimum(0.000001000000000);
        ...
        sizePolicy3.setHeightForWidth(mElevationAxisMajorLinesSymbolButton->sizePolicy().hasHeightForWidth());
        mElevationAxisMajorLinesSymbolButton->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(mElevationAxisMinorLinesSymbolButton->sizePolicy().hasHeightForWidth());
        mElevationAxisMinorLinesSymbolButton->setSizePolicy(sizePolicy3);
        ...
        sizePolicy2.setHeightForWidth(mElevationAxisLabelFontButton->sizePolicy().hasHeightForWidth());
        mElevationAxisLabelFontButton->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(mChartBorderSymbolButton->sizePolicy().hasHeightForWidth());
        mChartBorderSymbolButton->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(mChartBackgroundSymbolButton->sizePolicy().hasHeightForWidth());
        mChartBackgroundSymbolButton->setSizePolicy(sizePolicy3);
