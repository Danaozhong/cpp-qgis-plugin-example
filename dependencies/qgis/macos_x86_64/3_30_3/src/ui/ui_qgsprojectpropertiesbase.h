...
public:
    ...
    void setupUi(QDialog *QgsProjectPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 640, 971));
        ...
        titleBox->setSyncGroup(QString::fromUtf8("projgeneral"));
        ...
        btnGrpMeasureEllipsoid->setSyncGroup(QString::fromUtf8("projgeneral"));
        ...
        grpProjectScales->setSyncGroup(QString::fromUtf8("projgeneral"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 340, 57));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 634, 90));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 344, 817));
        ...
        groupBox->setSyncGroup(QString::fromUtf8("projstyles"));
        ...
        label_39->setPixmap(QPixmap(QString::fromUtf8(":/images/themes/default/text.svg")));

        gridLayout_11->addWidget(label_39, 4, 0, 1, 1);
        ...
        groupBox_2->setSyncGroup(QString::fromUtf8("projstyles"));
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/images/themes/default/mActionEditCopy.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mButtonCopyColors->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/images/themes/default/mActionEditPaste.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mButtonPasteColors->setIcon(icon17);
        ...
        mGroupBoxStyleDatabases->setSyncGroup(QString::fromUtf8("projgeneral"));
        ...
        mButtonAddStyleDatabase->setIcon(icon13);
        ...
        mButtonRemoveStyleDatabase->setIcon(icon14);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/images/themes/default/mActionNewPage.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mButtonNewStyleDatabase->setIcon(icon18);
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 176, 45));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 679, 1515));
        ...
        grpOWSServiceCapabilities->setCollapsed(false);
        grpOWSServiceCapabilities->setSyncGroup(QString::fromUtf8("projowsserver"));
        grpOWSServiceCapabilities->setSaveCollapsedState(true);
        ...
        gridLayout_25->addLayout(horizontalLayout_17, 14, 0, 1, 2);
        ...
        grpWMSList->setCollapsed(false);
        grpWMSList->setSaveCollapsedState(true);
        ...
        gridLayout_25->addLayout(horizontalLayout_18, 15, 0, 1, 2);
        ...
        gridLayout_25->addWidget(mUseAttributeFormSettingsCheckBox, 5, 0, 1, 2);
        ...
        mWMSPrintLayoutGroupBox->setCollapsed(false);
        mWMSPrintLayoutGroupBox->setSaveCollapsedState(true);
        ...
        gridLayout_25->addWidget(mWmsUseLayerIDs, 4, 0, 1, 2);
        ...
        gridLayout_25->addLayout(gridLayout_9, 11, 0, 1, 2);
        ...
        gridLayout_25->addLayout(mWMSDefaultMapUnitsPerMmLayout, 16, 0, 1, 2);
        ...
        gridLayout_25->addLayout(horizontalLayout_2, 10, 0, 1, 2);
        ...
        gridLayout_25->addLayout(horizontalLayout_10, 13, 0, 1, 2);
        ...
        gridLayout_25->addLayout(grpWMSPrecision, 9, 0, 1, 2);
        ...
        gridLayout_25->addWidget(mAddWktGeometryCheckBox, 6, 0, 1, 2);
        ...
        mLayerRestrictionsGroupBox->setCollapsed(false);
        mLayerRestrictionsGroupBox->setSaveCollapsedState(true);
        ...
        grpWMSExt->setCollapsed(false);
        grpWMSExt->setSaveCollapsedState(true);
        ...
        gridLayout_25->addWidget(mSegmentizeFeatureInfoGeometryCheckBox, 7, 0, 1, 2);

        mAddLayerGroupsLegendGraphicCheckBox = new QCheckBox(wms);
        mAddLayerGroupsLegendGraphicCheckBox->setObjectName(QString::fromUtf8("mAddLayerGroupsLegendGraphicCheckBox"));

        gridLayout_25->addWidget(mAddLayerGroupsLegendGraphicCheckBox, 8, 0, 1, 1);
        ...
        QWidget::setTabOrder(cbxStyleRandomColors, mButtonAddColor);
        ...
        QWidget::setTabOrder(mButtonExportColors, mListStyleDatabases);
        ...
        mOptionsStackedWidget->setCurrentIndex(10);
