...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 239, 480));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 110, 87));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 493, 473));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 263, 713));
