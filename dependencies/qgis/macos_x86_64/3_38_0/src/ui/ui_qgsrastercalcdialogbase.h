...
public:
    ...
    void setupUi(QDialog *QgsRasterCalcDialogBase)
    {
        ...
        QgsRasterCalcDialogBase->resize(664, 862);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 806, 808));
        ...
        mExpressionValidLabel = new QLabel(scrollAreaWidgetContents);
        mExpressionValidLabel->setObjectName(QString::fromUtf8("mExpressionValidLabel"));

        verticalLayout_5->addWidget(mExpressionValidLabel);
