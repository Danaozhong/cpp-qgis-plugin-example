...
public:
    ...
    void setupUi(QWidget *QgsQueryResultWidgetBase)
    {
        ...
        mSqlEditorContainer = new QWidget(QgsQueryResultWidgetBase);
        mSqlEditorContainer->setObjectName(QString::fromUtf8("mSqlEditorContainer"));

        verticalLayout->addWidget(mSqlEditorContainer);
        ...
        mClearButton = new QToolButton(QgsQueryResultWidgetBase);
        mClearButton->setObjectName(QString::fromUtf8("mClearButton"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/themes/default/console/iconClearConsole.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mClearButton->setIcon(icon);
        mClearButton->setAutoRaise(false);
    ...
    void retranslateUi(QWidget *QgsQueryResultWidgetBase)
    {
        ...
        mClearButton->setToolTip(QCoreApplication::translate("QgsQueryResultWidgetBase", "Clear", nullptr));
