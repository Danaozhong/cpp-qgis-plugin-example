...
public:
    ...
    void setupUi(QWidget *QgsProjectElevationSettingsWidgetBase)
    {
        ...
        groupBox_2 = new QGroupBox(QgsProjectElevationSettingsWidgetBase);
        ...
        mElevationRangeCheckBox = new QGroupBox(QgsProjectElevationSettingsWidgetBase);
        ...
        verticalLayout->addWidget(mElevationRangeCheckBox);
        ...
        mStackedWidget = new QgsStackedWidget(groupBox);
