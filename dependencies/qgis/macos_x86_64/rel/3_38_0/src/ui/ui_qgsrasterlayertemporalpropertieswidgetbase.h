...
"background: white;QgsCollapsibleGroupBoxBasic::title, QgsCollapsibleGroupBox::title {  subcontrol-origin: margin;  subcontrol-position: top left;  margin-left: 20px;  margin-right: 5px;  left: 0px;  top: 1px;}QgsCollapsibleGroupBoxBasic::title, QgsCollapsi"
        ...
        mBandRangesTable = new QTableView(mPageFixedRangePerBand);
        ...
        gridLayout_2->addWidget(mBandRangesTable, 1, 0, 1, 1);
        ...
        mCalculateFixedRangePerBandButton = new QToolButton(mPageFixedRangePerBand);
        ...
        verticalSpacer_2 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
