...
public:
    ...
    void setupUi(QWidget *WidgetCurvedLineCallout)
    {
        ...
        QWidget::setTabOrder(mMinCalloutLengthDDBtn, mOffsetFromLabelSpin);
        ...
        QWidget::setTabOrder(mOffsetFromLabelDDBtn, mLabelAnchorPointComboBox);
        QWidget::setTabOrder(mLabelAnchorPointComboBox, mLabelAnchorPointDDBtn);
        QWidget::setTabOrder(mLabelAnchorPointDDBtn, mDrawToAllPartsCheck);
        QWidget::setTabOrder(mDrawToAllPartsCheck, mDrawToAllPartsDDBtn);
        QWidget::setTabOrder(mDrawToAllPartsDDBtn, mOffsetFromAnchorSpin);
