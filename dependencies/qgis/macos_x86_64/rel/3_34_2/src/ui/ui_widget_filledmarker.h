...
public:
    ...
    void retranslateUi(QWidget *WidgetFilledMarker)
    {
        ...
        mHorizontalAnchorComboBox->setItemText(0, QCoreApplication::translate("WidgetFilledMarker", "Left", nullptr));
        mHorizontalAnchorComboBox->setItemText(1, QCoreApplication::translate("WidgetFilledMarker", "HCenter", nullptr));
        mHorizontalAnchorComboBox->setItemText(2, QCoreApplication::translate("WidgetFilledMarker", "Right", nullptr));

        mHorizontalAnchorDDBtn->setText(QCoreApplication::translate("WidgetFilledMarker", "\342\200\246", nullptr));
        mVerticalAnchorComboBox->setItemText(0, QCoreApplication::translate("WidgetFilledMarker", "Top", nullptr));
        mVerticalAnchorComboBox->setItemText(1, QCoreApplication::translate("WidgetFilledMarker", "VCenter", nullptr));
        mVerticalAnchorComboBox->setItemText(2, QCoreApplication::translate("WidgetFilledMarker", "Bottom", nullptr));
