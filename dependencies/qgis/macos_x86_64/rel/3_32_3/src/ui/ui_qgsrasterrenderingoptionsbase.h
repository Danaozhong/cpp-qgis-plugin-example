...
public:
    ...
    void setupUi(QWidget *QgsRasterRenderingOptionsWidgetBase)
    {
        ...
        gridLayout_35->addWidget(spnRed, 0, 2, 1, 1);
        ...
        gridLayout_35->addWidget(label_24, 0, 5, 1, 1);
        ...
        gridLayout_35->addWidget(spnBlue, 0, 6, 1, 1);

        spnGreen = new QgsSpinBox(widget);
        spnGreen->setObjectName(QString::fromUtf8("spnGreen"));

        gridLayout_35->addWidget(spnGreen, 0, 4, 1, 1);
        ...
        gridLayout_35->addWidget(label_23, 0, 3, 1, 1);
