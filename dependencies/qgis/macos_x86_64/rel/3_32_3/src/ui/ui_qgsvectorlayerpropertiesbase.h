...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 336, 562));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 164, 103));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 695, 552));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 374, 815));
