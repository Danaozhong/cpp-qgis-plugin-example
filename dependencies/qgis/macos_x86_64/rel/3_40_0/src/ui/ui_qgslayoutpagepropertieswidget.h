...
public:
    ...
    void setupUi(QWidget *QgsLayoutPagePropertiesWidget)
    {
        ...
        QgsLayoutPagePropertiesWidget->resize(385, 405);
        ...
        mHeightSpin->setShowClearButton(false);
        ...
        mWidthSpin->setShowClearButton(false);
        ...
        gridLayout_2->addWidget(mSymbolButton, 2, 1, 1, 1);
