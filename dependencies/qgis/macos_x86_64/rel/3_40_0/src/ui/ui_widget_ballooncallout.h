...
public:
    ...
    void setupUi(QWidget *WidgetBalloonCallout)
    {
        ...
        QWidget::setTabOrder(mAnchorPointComboBox, mMarkerSymbolButton);
        QWidget::setTabOrder(mMarkerSymbolButton, mAnchorPointDDBtn);
        QWidget::setTabOrder(mAnchorPointDDBtn, mCalloutBlendModeDDBtn);
