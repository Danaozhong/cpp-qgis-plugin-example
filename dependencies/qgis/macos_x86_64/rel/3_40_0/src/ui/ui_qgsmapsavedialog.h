...
public:
    ...
    QComboBox *mGeospatialPdfFormatComboBox;
    QLabel *label;
    ...
    void setupUi(QDialog *QgsMapSaveDialog)
    {
        ...
        mGeospatialPdfFormatComboBox = new QComboBox(page_2);
        mGeospatialPdfFormatComboBox->setObjectName(QString::fromUtf8("mGeospatialPdfFormatComboBox"));

        gridLayout_2->addWidget(mGeospatialPdfFormatComboBox, 1, 1, 1, 1);
        ...
        gridLayout_2->addWidget(mExportGeospatialPdfFeaturesCheckBox, 2, 0, 1, 2);
        ...
        QWidget::setTabOrder(mGeospatialPDFGroupBox, mGeospatialPdfFormatComboBox);
        QWidget::setTabOrder(mGeospatialPdfFormatComboBox, mExportGeospatialPdfFeaturesCheckBox);
