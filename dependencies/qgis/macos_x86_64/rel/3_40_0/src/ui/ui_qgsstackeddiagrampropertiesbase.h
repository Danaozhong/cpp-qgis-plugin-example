...
public:
    ...
    void setupUi(QWidget *QgsStackedDiagramPropertiesBase)
    {
        ...
        mSubDiagramsView->setSelectionMode(QAbstractItemView::SelectionMode::SingleSelection);
        mSubDiagramsView->setItemsExpandable(false);
        mSubDiagramsView->setExpandsOnDoubleClick(false);
        mSubDiagramsView->header()->setMinimumSectionSize(57);
        mSubDiagramsView->header()->setDefaultSectionSize(110);
